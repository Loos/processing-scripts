...
void setup(){
  ...
  ballz = new ball[num];
  ballz[0] = new ball(.1, 8, 100, 50,   0, 50, "220.mp3");
  ballz[1] = new ball(0, 9, 200, 50,   32, 50, "367.mp3");
  ballz[2] = new ball(0, 10, 300, 50,   64, 50, "513.mp3");
  ballz[3] = new ball(0, 11, 400, 50,   96, 50, "660.mp3");
  ballz[4] = new ball(0, 12, 500, 50,   128, 50, "220.mp3");
  ballz[5] = new ball(0, 13, 600, 50,   160, 50, "367.mp3");
  ballz[6] = new ball(0, 14, 700, 50,   192, 50, "513.mp3");
  ballz[7] = new ball(0, 15, 800, 50,   224, 50, "660.mp3");
  /*
...
class ball{
  ...
  ball(float x, float y, float xp, float yp, float ct, float dt, String ttone)  {
  ...
  void display(){
    ...
    noStroke();
    for (int i = 0; i < l; i ++){
      fill(c, 255, 255, i*255./l);
      ellipse(ps[i].x, ps[i].y, d, d);
    }
